...
frontend/
  src/
    ...
    views/        Status · Temp · Extrude · Move · Tune · Files · Macros · Console · Power · Settings (side-rail destinations)
    locales/      19 namespaced catalog folders (console/control/extrude/files/macros/move/osk/power/prompt/settings/shell/status/temp/tune)
