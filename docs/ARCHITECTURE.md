...
frontend/
  src/
    ...
    views/        Status · Temp · Extrude · Move · Tune · BedMesh · Files · Macros · Console · Power · Settings (side-rail destinations)
    locales/      19 namespaced catalog folders (console/control/extrude/files/macros/mesh/move/osk/power/prompt/settings/shell/status/temp/tune)
